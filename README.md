...
| `wordpress` | **CMS** — WordPress detection: version disclosure, plugin/emoji/jQuery-Migrate bloat, default tagline, ugly permalinks, and opt-in xmlrpc/user-enumeration/directory-listing/readme probes |
